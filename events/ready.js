...
module.exports = {
  ...
  async execute() {
    ...
    const statuses = [`${client.guilds.cache.get('892603177248096306').name}`, `${client.users.cache.size} Users`, `discord.js v13`, `Coded by ${client.users.cache.get('697414293712273408').tag}`, `${client.guilds.cache.size} Guilds`]

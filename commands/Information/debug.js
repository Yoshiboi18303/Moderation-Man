...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand(subcommand => subcommand
      ...
      .addStringOption(option => option
        .setName("permissions")
        .setDescription("Choose what you want to debug with the client permissions")
        .setRequired(true)
        .addChoice("check", "c")
      )
    )
    .addSubcommand(subcommand => subcommand
      ...
      .addStringOption(option => option
        .setName("permissions")
        .setDescription("Choose what you want to debug with the member permissions")
        .setRequired(true)
        .addChoice("check", "c")
      )
  ...
  async execute(interaction) {
    ...
    if(subcommand == "client") {
      ...
      var permission_choice = interaction.options.getString("permissions")
      var member = interaction.options.getMember("member") || interaction.member
      switch(permission_choice) {
        case "c":

...
module.exports = {
  ...
  async execute(interaction) {
    ...
    .then(async (user) => {
      return await interaction.reply({ content: `Unbanned **${user.tag}** from the guild!` })
    })
    .catch(async () => {
      return await interaction.reply({ content: 'This member is **NOT** on the ban list, look at the ban list to see who\'s banned!', ephemeral: true })
    })
  }
}
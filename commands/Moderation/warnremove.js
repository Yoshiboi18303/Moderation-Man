...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand(subcommand => subcommand.setName("one").setDescription("Remove one of the warnings on a user!").addUserOption(option => option.setName("user").setDescription("Select a user to remove one of the warnings from").setRequired(true)).addIntegerOption(option => option.setName("warning_number").setDescription("Type in a warning number to delete").setRequired(true)))

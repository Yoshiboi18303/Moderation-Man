...
var jobs = ["Bot Developer", "Cashier", "Chef", "Scientist", "Moderator"];
              ...
              if (data.voted) {
                ...
                */
                ...
                const success_embed = new MessageEmbed()
                  ...
                  .setTitle("Success")
                  .setDescription(
                    `You worked as a ${random_job} and earned ${random_coins} coins out of it!`
                  );
                ...
                /*
                  ...
                  var random_coins = Math.floor(Math.random() * 350)
                */
                var random_job = jobs[Math.floor(Math.random() * jobs.length)];
                data = await Profiles.findOneAndUpdate(
                  {

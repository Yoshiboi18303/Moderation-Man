...
module.exports = {
  ...
  async execute(interaction) {
    if(interaction.user.id != config.bot.owner) return await interaction.reply({ content: `${nope} - You are **NOT** the owner of this bot!`, ephemeral: true })
    client.stats.post()
    const success_embed = new MessageEmbed()
      .setColor(colors.green)
      .setTitle("Success!")
      .setDescription(`Successfully posted stats on **${client.user.username}** to Statcord!\nThere could've been a problem though, please check the console.`)

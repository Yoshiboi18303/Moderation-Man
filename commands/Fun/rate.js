...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addStringOption(option => option.setName("content").setDescription("The content to rate").setRequired(true)),
  async execute(interaction) {
    ...
    const rated_embed = new MessageEmbed()
      ...
      .setDescription(`${client.user.username}: "I rate ${content} a ${Math.floor(Math.random() * 11)}/10."`)
